...
<body>
  ...
  <div class="content-container lg:flex lg:flex-row w-full">
    ...
    <div class="user-dashboard-content-container pt-5 px-6 pb-5 bg-emerald-100 w-full lg:w-3/4 xl:w-4/5 2xl:w-4/5">
        <!-- SALES -->
        <div class="sales-dashboard grid mb-5 rounded-lg border border-gray-200 lg:grid-cols-4 shadow-xl">
        ...
        <div style="height: 66%;" class="grid grid-rows-4 lg:grid-rows-2 grid-cols-2 lg:grid-cols-4 gap-4">
            <!-- MEMBERS -->
            <div class="order-first row-span-1 col-span-2 grid mb-6 rounded-lg border border-gray-200 grid-cols-2 shadow-xl w-full h-full">
            ...
            <div class="order-last lg:order-12 row-span-2 col-span-2 grid mb-6 rounded-lg border border-gray-200 lg:grid-cols-1 shadow-xl w-full h-full">
            ...
            <!-- PAYOUT -->
            <div class="lg:order-last col-span-2 grid mb-6 rounded-lg border border-gray-200 grid-cols-2 shadow-xl w-full h-full">
                <figure class="flex flex-col justify-center items-center text-center bg-white rounded-l-lg border-b border-gray-200 lg:rounded-t-none lg:rounded-tl-lg border-r">
