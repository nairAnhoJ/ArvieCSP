<div id="drawer-navigation" class="hidden overflow-hidden md:block pt-6 drop-shadow-2xl border br-2 fixed z-40 p-4 overflow-y-auto bg-white w-80 md:w-1/4 2xl:w-1/5" tabindex="-1" aria-labelledby="drawer-navigation-label">
  ...
  <div class="py-4 overflow-y-auto">
      <ul class="space-y-2">
         <li>
            <a href="./index.php" class="flex items-center p-2 text-base font-normal text-white rounded-lg bg-emerald-700">
         ...
         <li>
            <a href="./members.php" class="flex items-center p-2 text-base font-normal text-gray-600 rounded-lg hover:bg-emerald-600 hover:text-white">
