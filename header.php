<nav class="navbar px-2 sm:px-4 py-2.5 sm:pt-2.5 bg-emerald-800 fixed w-full z-20 top-0 left-0 border-b border-gray-600">
  <div class="container flex flex-wrap justify-between items-center mx-auto">
    ...
    <button data-collapse-toggle="navbar-sticky" type="button" class="burger-button inline-flex items-center p-2 text-sm text-white rounded-lg md:hidden focus:outline-none" aria-controls="navbar-sticky" aria-expanded="false">
    ...
    <a href="./index.php" class="flex items-center">
        ...
        <span class="self-center text-l font-semibold whitespace-nowrap text-white">ARVIE CSP</span>
    </a>

    <div class="flex md:order-2">
        <a href="./login.php" class="text-neutral-300 hover:text-white border border-neutral-300 hover:border-white font-medium rounded-lg text-sm px-7 py-2.5 text-center mr-3 md:mr-0">Sign In</a>
    </div>

    <div class="nav-items hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
